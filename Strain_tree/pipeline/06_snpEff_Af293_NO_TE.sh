#!/usr/bin/bash 
#SBATCH --mem=16G --nodes 1 --ntasks 2 --out logs/snpEff.log -p batch
...
COMBVCF="../$FINALVCF/$PREFIX.selected.SNP.NO_TEs.vcf.gz ../$FINALVCF/$PREFIX.selected.INDEL.NO_TEs.vcf.gz"
for n in $COMBVCF
do
 echo $n
